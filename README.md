...
## 私たちの考える、責任のあるAI（Responsible AI）

AIの進化は凄まじく、既に一部の領域では人間を超えた存在となりつつあります。
だからこそ、我々開発者はAIが人類の未来に与える影響を真剣に考える必要があります。

「人をダメにするサービス」——このテーマは受け取り方次第で、10年後の人類の姿を大きく左右します。
それほどまでに、いまのAIの性能は良くも悪くも可能性に満ちているものです。

例えば、SNSのレコメンドシステム。エンゲージメント最大化を目的に設計された機械学習モデルは、見事にその目的を達成しました。
一方で、分断・依存・メンタルヘルス悪化という形で人類に返ってきています。
AIは与えられた目的には驚くほど忠実です。しかし副作用には無関心です。これは、開発者として私たちが忘れてはいけない事実です。

面倒な作業をAIに任せて人間を楽にすることは、素晴らしいことです。
「人をダメにする」というテーマにも、さまざまな切り口があります——便利さ、快適さ、中毒性、ユーモア、いろいろな角度から考えられるテーマです。その中で私たちが選んだのは、主体性や心の在り方という、もう少しやわらかい領域でした。
ここで AI が安易に「楽にしてあげる」と振る舞うと、人間は自分の足で立つ力を少しずつ失ってしまうかもしれません。

だからナマケモノの森は、「楽にする」ではなく「肯定する」を選びました。肯定する AI は、心にある力を呼び起こす。
ダメな自分を肯定された人間は、やがて自分から動き出す。依存は生まれない。代わりに、自発性が生まれる。
AIが心の領域で人間を代替するのではなく、人間の中にある力を引き出すために動く。

それが、私たちの考える、責任のあるAIです。
